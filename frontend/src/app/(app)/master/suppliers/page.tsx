/**
 * Suppliers Page - Server Component
 *
 * Server-side rendered page that fetches initial supplier data
...
export default async function SuppliersPage() {
  ...
  // Fetch initial suppliers data on server
  let initialData: SupplierListResponse;

  try {
    const response = await apiFetch<ApiSuccessResponse<SupplierListResponse>>({
      endpoint: '/suppliers',
      params: {
        page: 1,
        page_size: 20,
    ...
    console.error('[Suppliers Page] Failed to fetch initial data:', error);
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-1 flex-col items-center justify-center min-h-[400px] gap-4 p-4">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                {error instanceof Error ? error.message : 'Terjadi kesalahan saat memuat data supplier'}
              </p>
