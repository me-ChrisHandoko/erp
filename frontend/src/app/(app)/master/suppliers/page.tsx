 ...
 * Suppliers List Page
 *
 * Displays and manages supplier catalog with:
 * - Supplier table with sorting & pagination
...
export default function SuppliersPage() {
  ...
  const canDeleteSuppliers = permissions.canDelete("suppliers");
  ...
  useEffect(() => {
    const authTimeout = setTimeout(() => {
      if (!isAuthenticated || !accessToken) {
        console.log("[SuppliersPage] Not authenticated, redirecting to login...");
        router.push("/login");
      }
    }, 2000);
  ...
  // 🔐 FIX #1: Skip query until company context is ready
  const {
    data: suppliersData,
    isLoading,
    error,
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          <Card className="shadow-sm">
            <CardContent>
              ...
              {isLoading && (
                <div className="py-12">
                  <LoadingSpinner size="lg" text="Memuat data supplier..." />
                </div>
              )}
                ...
                <>
                  ...
                  statusFilter === undefined ? (
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Pagination */}
                      {suppliersData.pagination.totalPages > 1 && (
                        <div className="flex items-center justify-between border-t pt-4">
                          <div className="text-sm text-muted-foreground">
                            Halaman {suppliersData.pagination.page} dari{" "}
                            {suppliersData.pagination.totalPages} (
                            {suppliersData.pagination.total} supplier)
                          </div>
                          <div className="flex gap-2">
                            <Button
                              ...
                              onClick={() =>
                                handlePageChange(
                                  suppliersData.pagination.page - 1
                                )
                              }
                              disabled={suppliersData.pagination.page === 1}
                            >
                              Sebelumnya
                            </Button>
                            <Button
