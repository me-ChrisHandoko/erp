 ...
 * Customers List Page
 *
 * Displays and manages customer database with:
 * - Customer table with sorting & pagination
...
import type { CustomerFilters, CustomerType } from "@/types/customer.types";
  ...
  useEffect(() => {
    ...
    const authTimeout = setTimeout(() => {
      if (!isAuthenticated || !accessToken) {
        console.log(
          "[CustomersPage] Not authenticated, redirecting to login..."
        );
        router.push("/login");
      }
    }, 2000);
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          <Card className="shadow-sm">
            <CardContent>
              ...
              {/* Data Display */}
              {!isLoading && !error && customersData?.data && customersData.data.length > 0 && (
                <>
                  <CustomersTable
