/**
 * Warehouses Client Component
 *
 * Client-side interactive component for warehouse management.
...
interface WarehousesClientProps {
  initialData: WarehouseListResponse;
}
...
export function WarehousesClient({ initialData }: WarehousesClientProps) {
  ...
  const {
    ...
    error,
    refetch,
  } = useListWarehousesQuery(queryParams, {
  ...
  const displayData = warehousesData || initialData;
                  ...
                  action={
                    canCreateWarehouses
                      ? {
                          label: "Tambah Gudang",
                          onClick: () =>
                            router.push("/master/warehouses/create"),
                        }
                      : undefined
                  }
                />
