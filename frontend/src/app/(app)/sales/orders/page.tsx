/**
 * Sales Orders Page - Server Component
 *
 * Server-side rendered page that fetches initial sales order data
...
import type { SalesOrderListResponse } from "@/types/sales-order.types";
...
export default async function SalesOrdersPage() {
  ...
  // Fetch initial sales orders data on server
  let initialData: SalesOrderListResponse;

  try {
    const response = await apiFetch<ApiSuccessResponse<SalesOrderListResponse>>({
    ...
    console.error('[Sales Orders Page] Failed to fetch initial data:', error);
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-1 flex-col items-center justify-center min-h-[400px] gap-4 p-4">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                {error instanceof Error ? error.message : 'Terjadi kesalahan saat memuat data pesanan penjualan'}
              </p>
