...
export default async function PaymentsPage() {
  ...
  let initialData: PaymentListResponse;

  try {
    const response = await apiFetch<ApiSuccessResponse<PaymentListResponse>>({
    ...
    console.error('[Payments Page] Failed to fetch initial data:', error);
  ...
  return (
    <ErrorBoundary>
      <div className="flex flex-col">
        ...
        <PaymentsClient initialData={initialData} />
      </div>
    </ErrorBoundary>
  );
}
