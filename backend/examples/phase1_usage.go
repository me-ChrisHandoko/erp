...
func ExampleCreateTenantWithTrial(database *gorm.DB, companyID string) {
	...
	fmt.Printf("✅ Tenant created with ID: %s (Trial until: %s)\n",
...
func ExampleCreateSubscription(database *gorm.DB) {
	...
	fmt.Printf("✅ Subscription created with ID: %s (Price: Rp %s/month)\n",
...
func ExampleLinkTenantToSubscription(database *gorm.DB, tenantID, subscriptionID string) {
	...
	fmt.Println("✅ Tenant upgraded to paid subscription")
}
...
func ExampleAssignUserToTenant(database *gorm.DB, userID, tenantID string) {
	...
	fmt.Printf("✅ User assigned to tenant with role: %s\n", userTenant.Role)
}
...
func ExampleAddCompanyBank(database *gorm.DB, companyID string) {
	...
	fmt.Printf("✅ Bank account added: %s - %s\n", bank.BankName, bank.AccountNumber)
}
...
func ExampleRecordSubscriptionPayment(database *gorm.DB, subscriptionID string) {
	...
	fmt.Printf("✅ Payment recorded: Rp %s (Invoice: %s)\n",
...
func ExampleFullOnboardingFlow(database *gorm.DB) {
	fmt.Println("🚀 Starting complete onboarding flow...")
	...
	fmt.Printf("1️⃣ Company created: %s\n", company.Name)
	...
	fmt.Printf("4️⃣ Owner assigned to tenant with OWNER role\n")
	...
	fmt.Printf("5️⃣ Bank account added: %s\n", bank.BankName)
	...
	fmt.Printf("6️⃣ Subscription created: Rp %s/month\n",
	...
	fmt.Printf("7️⃣ Tenant upgraded to ACTIVE status\n")

	fmt.Println("\n✅ Onboarding complete! Company is ready to use the ERP system.")
}
